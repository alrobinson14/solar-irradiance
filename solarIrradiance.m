...
[integrationTime, cr, photonsPerSecondPerCm2] = eventsCalculator(microsecondsSinceGpsEpochINT,...
...
function [integrationTime, cr, photonsPerSecondPerCm2] = eventsCalculator(microsecondsSinceGpsEpochint,...
        microsecondsSinceGpsEpochtele, intTime, counts)
